...
<div class="container mt-4">
    <h3 class="text-center col-12 bg-primary py-3 text-white my-2"> Edit Info About contact</h3>

    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card shadow">
                <div class="card-body">
                    <form id="form_con" method="POST" action="logic/crud/update.php">
                        ...
                        <a class="btn btn-primary" href="contact.php">retourner</a>
                    </form>
                </div>
            </div>
        </div>
